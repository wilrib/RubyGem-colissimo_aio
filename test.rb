...
p retrait.find_point_retrait_address('011430')

# ETIQUETTE ALLER
aller = Colissimo::Label.new
aller.colis_aller('Alex', 'XELA', '12 Rue de la Roquette', 'FR', 'Paris', '75011', 'test@gmail.com', 'DOS')

# ETIQUETTE RETOUR
retour = Colissimo::Label.new
retour.colis_retour('Alex', 'XELA', '12 Rue de la Roquette', 'FR', 'Paris', '75011', 'test@gmail.com', 'CORE')


# TRACKING INFORMATIONS
=begin
tracking = Colissimo::Tracking.new
p tracking.track('6C14365610897')=end
